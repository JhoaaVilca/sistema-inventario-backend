package tienda.inventario.seguridad;
...
import tienda.inventario.servicios.CustomUserDetailsService;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Módulo de caja
                // Permitir a ADMIN y USER acceder a todos los endpoints de caja
                .requestMatchers("/api/caja/**").hasAnyRole("ADMIN", "USER")
